...
class AnimatedToggleSign extends StatefulWidget {
  ...
  @override
  _AnimatedToggleSignState createState() => _AnimatedToggleSignState();
}

class _AnimatedToggleSignState extends State<AnimatedToggleSign> {
